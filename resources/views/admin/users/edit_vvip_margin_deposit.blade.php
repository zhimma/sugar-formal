...
<form method="POST" action="{{ route('users/VVIP_margin_deposit/save', $deposit->user->id) }}" class="the_form">
	{!! csrf_field() !!}
    <input type="hidden" name="balance_before" value="{{ $deposit->balance }}">
	<table class="table table-bordered table-hover" style="width: 50%">
        <tr>
            ...
            <td>
                <input type="number" min="0" name='balance_after' class="form-control" style="width:300px;" value="{{ old('balance', $deposit->balance) }}" id="">
            </td>
        </tr>
        <tr>
            <td colspan="2">
