    ...
    <table class="table-hover table table-bordered">
        ...
        <tr>
            ...
            <td>
                <div class="result">
                    @if ($user->meta->pic)
                    <div class="SimilarSearch" data-url="{{ url($user->meta->pic) }}"></div>
                    @else
                    <button class="btn btn-sm btn-dark mb-2" type="button" disabled>搜尋來源</button>
                    @endif
                </div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <div class="SimilarSearch" data-url="{{ url($pic->pic) }}"></div>
            </td>
        </tr>
        @endforeach
        @endif
...
<script>
    $(document).ready(function () {
        $('.SimilarSearch').each(function (index, element) {
            SimilarSearch(element);
        });
    });
    
    function SimilarSearch(element){
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $(element).empty();
                $(element).append('<p><button class="btn btn-sm btn-primary" type="button" onclick="SimilarSearch($(this).closest(\'div\'))">再次搜尋</button></p>');
