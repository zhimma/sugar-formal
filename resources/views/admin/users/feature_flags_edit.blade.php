...
<body style="padding: 15px;">
    ...
    <form action="/admin/global/feature_flags/edit" method="POST">
        ...
        <input type="number" class="form-control" id="priority" name="priority" value="{{json_decode($feature['description']) != null ? json_decode($feature['description'])->priority : ''}}" placeholder="priority">
        </div>
        @csrf
