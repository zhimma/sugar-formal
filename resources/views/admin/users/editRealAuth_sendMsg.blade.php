    ...
    <table class="table table-bordered table-hover">
        <tr>
            ...
            <td>
                <div>
                補交項目：
                    <input type="radio" class="patch_type" name="patch_type"  value=1>基本資料
                    <input type="radio" class="patch_type" name="patch_type" value=2>照片
                    <input type="radio" class="patch_type" name="patch_type" value=3>表單必填資料
                    <input type="radio" class="patch_type" name="patch_type" value=4>重錄視頻
                </div>               
            ...
            $(".tpl").click(
                function () {
                    ...
                    if(template_str.search('APPLY_DATE')>=0) {
                            error_msg+='申請日期：APPLY_DATE變數轉換失敗，請確認會員是否已提出認證申請，以免誤發訊息。';
                    }
