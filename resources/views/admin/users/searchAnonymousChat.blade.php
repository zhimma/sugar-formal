...
{{--                    <td>{{($row->engroup==1)?'男':'女'}}</td>--}}
                    ...
                    <td>
                        ...
                        @endif
                        <div class="btn-group">
                        @if($row->forbid_userID=='' || ($row->forbid_userExpireDate && $row->forbid_userExpireDate->lt(now()) ) )
                        ...
                        @endif
                        @if($row->warned_userID=='' || ($row->warned_userExpireDate && $row->warned_userExpireDate->lt(now()) ) )
                        ...
                        @if($row->banned_userID=='' || ($row->banned_userExpireDate && $row->banned_userExpireDate->lt(now()) ) )
