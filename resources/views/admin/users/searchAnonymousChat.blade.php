...
{{--                    <td>{{($row->engroup==1)?'男':'女'}}</td>--}}
                    ...
                    <td>
                        ...
                        @endif
                        <div class="btn-group">
                        @if($row->forbid_userID=='' || ($row->forbid_userExpireDate && $row->forbid_userExpireDate < \Carbon\Carbon::now()) )
                        ...
                        @endif
                        @if($row->warned_userID=='' || ( $row->warned_userExpireDate && $row->warned_userExpireDate < \Carbon\Carbon::now() ) )
                        ...
                        @if($row->banned_userID=='' || ($row->banned_userExpireDate && $row->banned_userExpireDate < \Carbon\Carbon::now()) )
