		...
		<div class="m-grid__item m-grid__item--fluid m-login__wrapper" style="padding: 0px;">
			<div>
				...
				<div class="row" style="margin-top: 100px; z-index: 2">
					...
					<h3 class="st-idx">全台人數最多的Sugar Daddy/Baby 交友網站。<h3>
					<h4 class="f-idx">我要找:</h4>
					@if(Auth::user())
						<a href="{!! url('dashboard/search') !!}" class="btn btn-idx btn-success" style="position: absolute; z-index: 4; margin-left: 74%; margin-top: 15%; border-radius: 30px;"> 甜心爹地
						</a>
						<a href="{!! url('dashboard/search') !!}" class="btn btn2-idx btn-outline-danger"> 甜心寶貝 </a>
					@else
						<a href="{!! url('register') !!}" class="btn btn-idx btn-success" style="position: absolute; z-index: 4; margin-left: 74%; margin-top: 15%; border-radius: 30px;"> 甜心爹地
						</a>
					...
					<div class="col-lg-3" style="text-align: center">
						<div class="m-portlet m-portlet--mobile m-portlet-idx">
							<div class="m-portlet__body">
								...
								<h3>高品質</h3>
								<p>全台最大的Sugar Daddy/Baby 交友網站，所有會員均經過嚴密的審核機制。杜絕非法以及別有用心的使用者。</p>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="col-lg-3">
						<img class="img-idx" src="img/sugar_0926-23.png" width="10%">
						<h4 style="display: inline-block"> 如果您是富豪新貴</h4>
					</div>
					<div class="col-lg-8">
						<hr class="sg-hr">
					</div>
								...
								<div class="m-list-timeline">
									<div class="m-list-timeline__items">
										...
										<div class="m-list-timeline__item">
											...
											<span class="m-list-timeline__text">
												<h5>直接坦白</h5>
												<p>這個交友網站就是讓大家直接坦白，不拐彎抹角，節省您兜圈子的時間。</p>
											</span>
										</div>
										<div class="m-list-timeline__item">
											<span class="m-list-timeline__badge m-list-timeline__badge--danger"></span>
				...
				<div class="row" style="margin-top: 30px;">
					...
					<div class="col-lg-3">
						<img src="img/sugar_0926-23.png" width="10%">
						<h4 style="display: inline-block"> 如果您是魅力寶貝</h4>
					</div>
					<div class="col-lg-8">
						<hr class="sg-hr">
					</div>
								...
								<div class="m-list-timeline">
									<div class="m-list-timeline__items">
										...
										<div class="m-list-timeline__item">
											...
											<span class="m-list-timeline__text">
												<h5>一圓各種夢想</h5>
												<p>有daddy交友網的幫忙，把握青春，出國留學，上課進修，提昇自我能力。</p>
											</span>
										</div>
										<div class="m-list-timeline__item">
											<span class="m-list-timeline__badge"></span>
