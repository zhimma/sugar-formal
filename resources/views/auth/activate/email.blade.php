...
{{-- <div class="alert alert-danger"><h2>您好，因為信件發送系統產生錯誤，故暫時無法寄送驗證信。請您用註冊的 Email 寄信到站長信箱 admin@taiwan-sugar.net ，標題寫「手動驗證花園網」，或等24小時後來此站點選「重新發送驗證信」。</h2></div> --}}
@if(isset($user))
        <p><h3>帳號註冊成功</h3></p>
        <p>您已註冊成功，以下是您所填寫的註冊資料：<br>
        暱稱：{{ $user->name }}<br>
        標題：{{ $user->title }}<br>
        帳號類型：@if($user->engroup == 2)甜心寶貝@else甜心爹地@endif <br>
        Email：<a style="font-weight: bold">{{ $user->email }} (若Email填寫錯誤，請重新註冊)</a></p>
        ...
        @if(Auth::check() && isset($user))
            ...
            <a href="http://www.sugar-garden.org/notification" target="_blank">站長開講</a>
            <a href="http://www.sugar-garden.org/feature">網站使用</a>
            <a href="http://blog-tw.net/Sugar/%E5%8C%85%E9%A4%8A%EF%BC%8D%E5%A5%B3%E5%AD%A9%E7%AF%87/">站長的碎碎念(完整版)</a>
            ...
            <a href="http://www.sugar-garden.org/notification">站長開講</a>
            <a href="http://www.sugar-garden.org/feature">網站使用</a>
            <a href="http://blog-tw.net/Sugar/%E5%8C%85%E9%A4%8A%EF%BC%8D%E5%A4%A7%E5%8F%94%E7%AF%87/">站長的碎碎念(完整版)</a>
            @endif
        @endif
        <br>
        <hr>
