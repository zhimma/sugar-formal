					    ...
					    <div class="dengl matbot140">
                                   ...
                                   <div class="de_input">
                                         ...
                                         <div class="zybg_new_bg">
                                               <div class="zybg_new">
                                                   <select name="" class="zy_select"><option>台湾</option><option>大陆</option></select>
                                                   <input name="" type="text" class="xy_input" placeholder="請輸入手機號碼">
                                               </div>
                                               <a class="zybg_right">驗證</a>
                                         </div>
                                      ...
                                      <div class="de_input">
                                          ...
                                          <div class="zy_kuang">
                                              <img src="/auth/images/photo_01.png">
                                              <span>上傳照片</span>
                                          </div>
...
<div class="bl bl_tab " id="tab01" style="display: block;">
