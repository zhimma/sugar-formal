...
<input type="text" disabled="disabled" 
    class="re_rinput ga_tabbot {{$service->getQuValueAttrByEntry($question_entry,$sub_choice_entry->id,'form_org_ans_reply_sub_choice__'.$question_entry->id.'__'.$sub_choice_entry->id.'_')}}" 
