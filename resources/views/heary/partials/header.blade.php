...
@else
    <header class="clearfix weui-pl32 weui-pt20 headerbg weui-pb15">
        ...
        <a href="/login" class="weui-fr weui-white weui-mr30 weui-pt13">登入</a> 
        <a href="/register" class="weui-fr weui-white weui-mr30 weui-pt13">註冊</a>
    </header>
@endif