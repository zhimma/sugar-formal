			...
			<div class="row">
				...
				<div class="col-sm-12 col-xs-12 col-md-10">
					    <div class="g_password">
                             <div class="g_pwicon">
                                  <li><a href=""><img src="/img/mem/mm_03.png"><span>基本資料</span></a></li> 
                                  <li><a href=""><img src="/img/mem/mm_05.png"><span>照片管理</span></a></li> 
                                  <li><a href=""><img src="/img/mem/mm_07.png"><span>更改密碼</span></a></li> 
                                  <li><a href=""><img src="/img/mem/mm_18.png"><span>VIP</span></a></li> 
                             </div>       
                            ...
                            <div class="n_sjvip"  id="vip">
                                 <div class="vipline"><img src="/img/mem/VIP_05.png"></div>
                                 <div class="viplist">
                                            <ul>
                                                <li>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="vipcion"><img src="/img/mem/bicon.png"></div>
                                                </li>
                                                <li>
                                                    <div class="vipcent">cooming soon</div>
                            ...
                            <div class="de_input n_viptop20 n_viphig"  id="vip2" style="display:none">
                                  <div class="de_input01 dlmarbot"><div class="de_img"><img src="/img/mem/lo_03.png"></div><input name="" type="text" class="d_input" placeholder="帳號 (您的Email)"></div>
                                  <div class="de_input01 dlmarbot"><div class="de_img"><img src="/img/mem/lo_11.png"></div><input name="" type="password" class="d_input" placeholder="密碼"></div>
