		...
		<div class="col-sm-12 col-xs-12 col-md-12">
			<div class="commonMenu">
				...
				<ul id="menuList" class="change marg30" style="z-index: 10;">
					...
					<div class="coheight">
					<div class="heyctop">{{ $user->name }}@if($user->isVVIP()) (VVIP) @elseif($user->isVip()) (VIP) @endif @if(view()->shared('valueAddedServices')['hideOnline'] ?? 0 == 1 && $use->is_hide_online)<br>(隱藏)@endif</div>
						<div class="juanzhou">
							<div class="helist">
								<ul>
									<li>
