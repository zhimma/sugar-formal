                    ...
                    @if($user->engroup==1)
                        ...
                        <dt>
                            ...
                            <span style="text-align:center;">
                                <input id="budget_per_month_min" name="budget_per_month_min" type="number" style="width:48%;" class="select_xx01 se_zlman left"  placeholder="請輸入最低金額" value="{{$umeta->budget_per_month_min}}" data-parsley-errors-messages-disabled onchange="c5('每月預算是非常重要的欄位，請確實填寫，如果被檢舉浮報或未給，查證屬實。將會有”預算不實”的標籤。')">
                                ~
                                <input id="budget_per_month_max" name="budget_per_month_max" type="number" style="width:48%;" class="select_xx01 se_zlman right"  placeholder="請輸入最高金額" value="{{$umeta->budget_per_month_max}}" data-parsley-errors-messages-disabled>
                            </span>
                        </dt>
                        <dt>
                            <span>車馬費預算</span>
                            <span style="text-align:center;">
                                <input id="transport_fare_min" name="transport_fare_min" type="number" style="width:48%;" class="select_xx01 se_zlman left"  placeholder="請輸入最低金額" value="{{$umeta->transport_fare_min}}" data-parsley-errors-messages-disabled onchange="c5('車馬費預算是非常重要的欄位，請確實填寫，如果被檢舉浮報或未給查證屬實。將會有”車馬費不實”的標籤。')">
                                ~
                                <input id="transport_fare_max" name="transport_fare_max" type="number" style="width:48%;" class="select_xx01 se_zlman right"  placeholder="請輸入最高金額" value="{{$umeta->transport_fare_max}}" data-parsley-errors-messages-disabled>
                            </span>
                        </dt>
                    @endif
                </div>
