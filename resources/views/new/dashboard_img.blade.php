                    ...
                    <div class="two_container">
                        ...
                        @endphp
                         <h2>為保護會員隱私，網站可以設定照片自動模糊化</h2>
                          <ul>
                              <li><span>◎</span>VVIP 或 PR 值大於 80 的會員，會自動顯示清晰照片</li>
                    ...
                    <div class="row mb-4 ">
                        <div class="col-sm-12 col-lg-12">
                            <form id="avatar_upload_form" @if($rap_service->isInRealAuthProcess()) action="{{route('dashboard/avatar/upload',['real_auth'=>request()->real_auth])}}" @else action="{{ url('/dashboard/avatar/upload') }}" @endif method="post" enctype="multipart/form-data">
                                ...
                                <input type="submit" class="se_but1 vipbut upload_btn abtn" value="上傳大頭照" style="border-style: none;float:unset;width:250px !important;" onclick="disable_onbeforeunload_hint();">
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12 col-lg-12">
                            <div>
                                <form id="mempic_upload_form"@if($rap_service->isInRealAuthProcess()) action="{{route('dashboard/pictures/upload',['real_auth'=>request()->real_auth])}}" @else action="{{ url('/dashboard/pictures/upload') }}" @endif method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="userId" value="{{ $user->id }}">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    <input type="submit" class="se_but1 vipbut upload_btn abtn" value="上傳生活照" style="border-style: none;float:unset;width:250px !important;" onclick="disable_onbeforeunload_hint();">
                                </form>
                            </div>
                            <div>
