...
{{--            <a class="item" href="{!! url('dashboard/board') !!}"><li><img src="/new/images/z_03.png"><span>留言板</span></li></a>--}}
           ...
           {{-- @if(isset($user) && $user->engroup == 1)
            ...
            @if (isset($user) && ($user->isVip() || $user->isVVIP()))
                <a class="item" href="{!! url('/dashboard/search_discard/list') !!}"><li style="float:@if($user->engroup == 1) left; @else left; @endif"><img src="/new/images/z_12.png"><span class="n_zylg">略過名單</span></li></a>
            @else
