          ...
          <div class="n_adbut recoverAllBtn" style="display:none"><a style="cursor:pointer"><img src="/new/images/1_06.png">復原</a></div>
            ...
            @if($user->engroup==1)
                @php $count = 6-count($member_pics) @endphp
                    ...
                    @if($key==0)
                    <li class="write_img editBtn" id="{{$member_pic->id}}"><div class="delpicBtn"><img src="/new/images/gb_icon01.png" width="30px" height="30px"></div><div class="n_ulhh"><img src="/new/images/ph_03.png"></div><b class="img" style="background:url('{{$member_pic->pic}}'); background-size:contain;background-position:50% 50%;background-repeat:no-repeat;"></b></li>
                    @else
                    <li class="write_img editBtn" id="{{$member_pic->id}}"><div class="delpicBtn"><img src="/new/images/gb_icon01.png" width="30px" height="30px"></div><div class="n_ulhh"><img src="/new/images/ph_05.png"></div><b class="img" style="background:url('{{$member_pic->pic}}'); background-size:contain;background-position:50% 50%;background-repeat:no-repeat;"></b></li>
                    @endif
                    @endforeach

                @if($count>0)
                    @for($i=0;$i<$count;$i++)
                    <li class="write_img"><div class="n_ulhh"><img src="@if($i==0 && $count==6) /new/images/ph_03.png @else /new/images/ph_05.png @endif"></div><b class="img" style="background:url(/new/images/ph_12.png); background-size:contain;background-position:50% 50%;background-repeat:no-repeat;"></b></li>
                    @endfor
                @endif 
            @else
                @php 
                ...
                @if($count>0)
                    @if($count_vip>0)
                        ...
                        <li class="write_img"><div class="n_ulhh"><img src="/new/images/ph_05.png"></div><b class="img" style="background:url(/new/images/ph_12.png); background-size:contain;background-position:50% 50%;background-repeat:no-repeat;"></b></li>
                        @endfor
                    @else
                        @for($i=0;$i<$count;$i++)
                        <li class="write_img"><div class="n_ulhh"><img src="/new/images/ph_05.png"></div><b class="img" style="background:url(/new/images/ph_12.png); background-size:contain;background-position:50% 50%;background-repeat:no-repeat;"></b></li>
            ...
            @endif
               ...
               <!-- <li class="write_img"><div class="n_ulhh"><img src="/new/images/ph_05.png"></div><b class="img" style="background:url(/new/images/ph_10.png); background-size:contain;background-position:50% 50%;background-repeat:no-repeat;"></b></li>
               <li class="write_img"><div class="n_ulhh"><img src="/new/images/ph_05.png"></div><b class="img" style="background:url(/new/images/ph_10.png); background-size:contain;background-position:50% 50%;background-repeat:no-repeat;"></b></li>
               <li class="write_img"><div class="n_ulhh"><img src="/new/images/ph_05.png"></div><b class="img" style="background:url(/new/images/ph_10.png); background-size:contain;background-position:50% 50%;background-repeat:no-repeat;"></b></li>
               <li class="write_img"><div class="n_ulhh"><img src="/new/images/ph_05.png"></div><b class="img" style="background:url(/new/images/ph_12.png); background-size:contain;background-position:50% 50%;background-repeat:no-repeat;"></b></li>
               <li class="write_img"><div class="n_ulhh"><img src="/new/images/ph_05.png"></div><b class="img" style="background:url(/new/images/ph_12.png); background-size:contain;background-position:50% 50%;background-repeat:no-repeat;"></b></li> -->
