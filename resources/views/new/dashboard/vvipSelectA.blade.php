...
{{--                                        <font>4:若審核通過兩周內未完成 VVIP 月費繳費，視為審核失敗，取消申請，扣除手續費 4000，剩餘刷退。</font>--}}
                                        ...
                                        <div class="vip_h3"><font>7:刷卡完成後，須於<r>72小時</r>內匯20000元入指定帳戶，否則將取消此次 VVIP 申請。9888 元扣除手續費4000，剩餘刷退。</font></div>
...
{{--                <h2 class="matop00">●無償贈與 2 萬元予站方作為入會費。</h2>--}}
{{--                <h2 class="matop00">●入會費用途：此帳號所有爭議處理費用皆由入會費扣除。</h2>--}}
{{--                <h2 class="matop00">●入會費保留：若帳號暫停使用，不支付 VVIP 月費。入會費保留，願意支付 VVIP 月費時會繼續享有 VVIP 權益。</h2>--}}
{{--                <h2 class="matop00">●帳號/入會費不得轉讓他人使用。</h2>--}}
{{--                <h2 class="matop00">●入會費退還：若不再使用本站，入會費不退還。</h2>--}}
{{--                <h2 class="matop00">●入會費不足額：入會費低於2萬時須補足到5萬，否則取消 VVIP 權限。取消 VVIP 權限時，入會費不退還。已繳之 VVIP 費用依照使用比例天數退還。</h2>--}}
{{--                <h2 class="matop00">●刷卡完後後，須於72小時內匯20000元入指定帳戶，否則將取消此次 VVIP 申請。9888 元扣除手續費4000，剩餘刷退。</h2>--}}
{{--                <h2 class="matop00">★以上若有爭議由站方全權決定，站方亦無說明入會費使用義務，申請人絕無異議。</h2>--}}
