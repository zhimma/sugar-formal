...
{{--                        <li><a href="{!! url('dashboard/vipSelect') !!}" class="g_pwicon_t4 g_hicon4"><span>升級付費</span></a></li>--}}
                    ...
                    <div class="zhapian vvip_hg">
                        ...
                        <div class="vvip_a_1">
                            <div class="vip_bg">
                                <div class="vip_title02">A方案</div>
                                <div class="vip_font">
                                    <div class="vip_h3"><i>●</i><font>連續半年以上"信用卡"付費的 VIP</font></div>
                                    <div class="vip_h3"><i>●</i><font>或累積一年以上的 VIP 會員</font></div>
                                ...
                                <div class="vvip_tab matop10">
                                    ...
                                    <div class="vvip_tfont">
                                        ...
                                        <div class="tabfont">
                                            ...
                                            <font>f:扣繳憑單</font>
                                            <font>g:所得清單</font>
                                            <span>以上文件必須手機高清拍照，完整包含個人訊息，不可以有任何塗改</span>
                                        </div>
{{--                                        <h2>2:申請流程：申請時刷季費9888，若審核未過扣除手續費 4000，剩餘刷退；通過則成為當期費用；若 VVIP 到期未續費則須重新審核。</h2>--}}
{{--                                        <h2>3:申請通過後需無償贈與站方20000作為預備金，若不同意請勿申請。</h2>--}}
{{--                                        <h2>4:若審核通過兩周內未完成 VVIP 月費繳費，視為審核失敗，取消申請，扣除手續費 4000，剩餘刷退。</h2>--}}
                                        <h2>2:VVIP 季費 9888 元。</h2>
                                        <h2>3:無償贈與 2 萬元予站方作為預備金。</h2>
                                        <h2>4:預備金用途：此帳號所有爭議處理費用皆由預備金扣除。</h2>
                                        <h2>5:預備金保留：若帳號暫停使用，不支付 VVIP 會費。預備金保留，願意支付 VVIP 會費時會繼續享有 VVIP 權益。</h2>
                                        <h2>6:帳號/預備金不得轉讓他人使用。</h2>
                                        <h2>7:預備金退還：若不再使用本站，預備金不退還。</h2>
                                        <h2>8:預備金不足額：預備金低於2萬時須補足到5萬，否則取消 VVIP 權限。取消 VVIP 權限時，預備金不退還。已繳之 VVIP 費用依照使用比例天數退還。</h2>
                                        <h2>9:刷卡完成後，須於72小時內匯20000元入指定帳戶，否則將取消此次 VVIP 申請。9888 元扣除手續費4000，剩餘刷退。</h2>
                                        <h2>10.若違反本網站用戶規定，被申訴次數達一定次數，造成站方管理上困難，本網站有權取消用戶 VVIP 之身份。</h2>
                                        <h2>11.又，上述申訴不僅以次數作為判定標準，亦依情節嚴重性而認定。上述所提及之認定資格在站方，站方亦無說明義務。</h2>
                                        <h2>12.被申訴次數過多會造成帳號被取消，申請用戶需三思。</h2>
                                        <h2>13.若本網站自行斟酌後認為您的個人檔案內容或您在本網站中之行為違反使用條款，或您違反本協議，或因任何其他理由，本網站得暫停或終止您在本網站中使用者帳戶，以及您於本網站中全部或部分之使用。本網站亦得隨時移除您使用者帳戶之全部或部分或任何使用者內容。</h2>
                                        <h2>14.您同意上述終止事項無需事前通知即逕行生效，且本網站不需對您或任何第三方負責。</h2>
                                        <h2>15.若您欲取消申請、訂閱，您得隨時依照本協議之條款取消您的 VVIP 服務。您必須依照本網站服務內提供之說明取消，取消額外服務之說明如上所述。</h2>
                                        <h2>16.本網站保留權利更正錯誤（無論是透過更改本網站之服務內資訊、或是將錯誤通知於您並提供您取消訂購的機會，此外本站亦擁有不經通知下隨時更新資訊之權利）</h2>
                                        <h2 style="color: #f00;background-color: yellow;">★以上若有爭議由站方全權決定，站方亦無說明預備金使用義務，申請人絕無異議。</h2>
...
{{--                                </div>--}}
    ...
    <div class="bl bl_tab " id="tab01">
        <div class="bltitle"><font>A方案</font></div>
        <div class="new_poptk" style="width: 90%">
            <div class="viptkft" >
{{--                <h2 class="matop00">●若審核通過兩周內未完成VVIP會費繳費，視為審核失敗，取消申請，退刷4000元手續費。</h2>--}}
{{--                <h2 class="matop00">●此方案須付手續費8000元。若審核未通過，退刷手續費4000元。</h2>--}}
{{--                <h2 class="matop00">●通過後將取消目前的VIP付費。改以VVIP付費。</h2>--}}
{{--                <h2 class="matop00">●申請後取消申請，手續費不退還。</h2>--}}
{{--                <h2 class="matop00">●準核與否由站方全權決定，亦無說明義務。刷卡人絕無異議。</h2>--}}
{{--                <h2 class="matop00">●此方案須付手續費 10000元 + 第一季會員費 10000 元。同時停止原先的VIP扣款。</h2>--}}
...
{{--                <h2 class="matop00">●無償贈與 2 萬元予站方作為預備金。</h2>--}}
{{--                <h2 class="matop00">●預備金用途：此帳號所有爭議處理費用皆由預備金扣除。</h2>--}}
{{--                <h2 class="matop00">●預備金保留：若帳號暫停使用，不支付 VVIP 月費。預備金保留，願意支付 VVIP 月費時會繼續享有 VVIP 權益。</h2>--}}
{{--                <h2 class="matop00">●帳號/預備金不得轉讓他人使用。</h2>--}}
{{--                <h2 class="matop00">●預備金退還：若不再使用本站，預備金不退還。</h2>--}}
{{--                <h2 class="matop00">●預備金不足額：預備金低於2萬時須補足到5萬，否則取消 VVIP 權限。取消 VVIP 權限時，預備金不退還。已繳之 VVIP 費用依照使用比例天數退還。</h2>--}}
{{--                <h2 class="matop00">●刷卡完後後，須於72小時內匯20000元入指定帳戶，否則將取消此次 VVIP 申請。9888 元扣除手續費4000，剩餘刷退。</h2>--}}
{{--                <h2 class="matop00">★以上若有爭議由站方全權決定，站方亦無說明預備金使用義務，申請人絕無異議。</h2>--}}
