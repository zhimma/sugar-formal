            ...
            <div class="col-sm-12 col-xs-12 col-md-10 g_pnr01">
                ...
                <div class="v_bg_fb">
                    ...
                    <div class="v_fb_k">
                        ...
                        <div class="v_fb_knr">本功能為本站 VVIP 專有，可以通過站方審核後發布徵選活動。</div>
                        ...
                        <div class="v_fanr02">
                            ...
                            <li>
                                <span class="v_ficon"></span>
                                <span class="v_ftext">站方將依照您的徵選條件指定酬金，同意後匯款至指定帳戶即開始徵選活動。匯款後請加站長line告知帳號後五碼。</span>
                            </li>
                            <li>
                                <span class="v_ficon"></span>
                    ...
                    <div class="v_fb_k_gz">
                        ...
                        <div class="v_fanr02">
                            ...
                            <li class="v_fanr02_o">
                                <span class="v_ficon01"></span>
                                <span class="v_ftext">通過條件驗證的女會員將出現在您的徵選收件夾中。</span>
                            </li>
                            <li class="v_fanr02_o">
                                <span class="v_ficon01"></span>
                    ...
                    <div class="v_fb_k_gz">
                        ...
                        <div class="v_fanr02">
                            ...
                            <li class="v_fanr02_o">
                                <span class="v_ficon01"></span>
                                <span class="v_ftext">若見面後女方並不符合條件，請務必拍照或者用其他方式舉證，否則此筆費用預設將發放予女會員</span>
                            </li>
                        </div>
                    </div>
                    <img src="/new/images/xb06.png" style="width: 100%; margin: 0 auto; display: table; height: 15px;">
