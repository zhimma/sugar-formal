...
<!--                                --><?//=$_GET["body"][0]?>
                        ...
                        <dt class="matopj15">
                            <span>CUP</span>
                            <span class="line20">
                                <label class="n_tx"><input type="checkbox" name="cup[]" value="A" id="Check" @if( !empty( $_GET["cup"][0] ) && $_GET["cup"][0] == "A" ) checked @endif><i>A</i></label>
                                <label class="n_tx"><input type="checkbox" name="cup[]" value="B" id="Check1" @if( !empty( $_GET["cup"][1] ) && $_GET["cup"][1] == "B" ) checked @endif><i>B</i></label>
                                <label class="n_tx"><input type="checkbox" name="cup[]" value="C" id="Check2" @if( !empty( $_GET["cup"][2] ) && $_GET["cup"][2] == "C" ) checked @endif><i>C</i></label>
                                <label class="n_tx"><input type="checkbox" name="cup[]" value="D" id="Check3" @if( !empty( $_GET["cup"][3] ) && $_GET["cup"][3] == "D" ) checked @endif><i>D</i></label>
                                <label class="n_tx"><input type="checkbox" name="cup[]" value="E" id="Check4" @if( !empty( $_GET["cup"][4] ) && $_GET["cup"][4] == "E" ) checked @endif><i>E</i></label>
                                <label class="n_tx"><input type="checkbox" name="cup[]" value="F" id="Check5" @if( !empty( $_GET["cup"][5] ) && $_GET["cup"][5] == "F" ) checked @endif><i>F</i></label>
                            </span>
                        </dt>
                        @else
                        <dt class="matopj15">
...
@section('javascript')
   ...
   // var BootstrapSelect=function(){var t=function(){$(".m_selectpicker").selectpicker()};return{init:function(){t()}}}();jQuery(document).ready(function(){BootstrapSelect.init()});
        $('.twzipcode').twzipcode({
            'detect': true,
            'css': ['select_xx07', 'select_xx07', 'zipcode'], onCountySelect: function() {
