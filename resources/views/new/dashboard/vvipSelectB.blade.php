                    ...
                    <div class="zhapian vvip_hg">
                        ...
                        <div class="vip_bg">
                            ...
                            <div class="vip_font">
                                ...
                                <div class="vip_h3"><i>●</i><font>您同意上述終止事項無需事前通知即逕行生效，且您同意本網站不就該終止對您或任何第三方負責。</font></div>
                                <div class="vip_h3"><i>●</i><font>若您欲取消申請、訂閱，您得隨時依照本協議之條款取消您的 VVIP 服務。您必須依照本網站服務內提供之說明取消，取消額外服務之說明如上所述。</font></div>
                                <div class="vip_h3"><i>●</i><font>本網站保留權利更正錯誤（無論是透過更改本網站之服務內資訊、或是將錯誤通知您並提供您機會取消訂購）或不經通知隨時更新資訊。</font></div>
