...
@if($user->engroup == 1)
<form id="chemafeimsgbtn" style="display: none;" action=<?php echo Config::get('social.payment.actionURL'); ?> class="m-nav__link nav-link m-tabs__link" method="POST">
...
<a href="#m_modal_2" data-toggle="modal" data-target=""   class=" btn btn-danger1 weui-f16 weui-box_s weui-ml10  weui-mb10 cmfbtn" >車馬費評價</a>
@endif
