...
<ul class="nav nav-tabs m-tabs m-tabs-line m-tabs-line--left m-tabs-line--primary" role="tablist">
       ...
       <li class="nav-item m-tabs__item">
        ...
        @elseif($user->id !== $cur->id)
            ...
            @if ($user->isVip() && $user->id != $cur->id)
                <li class="nav-item m-tabs__item d-md-none">
                    <form action="{!! url('dashboard/fav') !!}" class="m-nav__link nav-link m-tabs__link" method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" >
                    <input type="hidden" name="userId" value="{{$user->id}}">
                    <input type="hidden" name="to" value="{{$cur->id}}">
                    <button type="submit" style="background: none; border: none; padding: 0">
                ...
                @if(!$isBlocked)
                    <li class="nav-item m-tabs__item d-md-none">
                        <form action="{!! url('dashboard/block') !!}" class="m-nav__link nav-link m-tabs__link" method="POST">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" >
                        <input type="hidden" name="userId" value="{{$user->id}}">
                        <input type="hidden" name="to" value="{{$cur->id}}">
                        <button type="submit" style="background: none; border: none; padding: 0">
                ...
                @else
                    <li class="nav-item m-tabs__item d-md-none">
                        <form action="{!! url('dashboard/unblock') !!}" class="m-nav__link nav-link m-tabs__link" method="POST">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}" >
                        <input type="hidden" name="userId" value="{{$user->id}}">
                        <input type="hidden" name="to" value="{{$cur->id}}">
                        <button type="submit" style="background: none; border: none; padding: 0">
...
@endif
    <?php
     ...
     ?>
        <div class="m-portlet__body">
            ...
            @if(str_contains(url()->current(), 'dashboard'))
            <div class="form-group m-form__group row twzipcode" id="twzipcode"><label class="col-form-label col-lg-2 col-sm-12">&nbsp;縣市<span style="color:red">(必填)</span></label>
            @else
    ...
    <div class="form-group m-form__group row">
    @if (str_contains(url()->current(), 'dashboard'))
        <label class="col-form-label col-lg-2 col-sm-12">預算&nbsp;<span style="color:red">(必填)</span></label>
    @else
...
<div class="form-group m-form__group row">
    <label class="col-form-label col-lg-2 col-sm-12"> @if(str_contains(url()->current(), 'dashboard'))出生日期&nbsp;<span style="color:red">(必填)</span>@else年齡@endif</label>
...
<div class="form-group m-form__group row">
    @if (str_contains(url()->current(), 'dashboard'))
        <label class="col-form-label col-lg-2 col-sm-12">身高 (cm)&nbsp;<span style="color:red">(必填)</span></label>
    @else
...
<div class="form-group m-form__group row">
    @if (str_contains(url()->current(), 'dashboard'))
        <label class="col-form-label col-lg-2 col-sm-12">關於我&nbsp;<span style="color:red">(必填)</span></label>
    @else
    ...
    @endif
            ...
            <div class="form-group m-form__group row">
                @if (str_contains(url()->current(), 'dashboard'))
                    <label class="col-form-label col-lg-2 col-sm-12">期待的約會模式&nbsp;<span style="color:red">(必填)</span></label>
                @else
...
<div class="form-group m-form__group row">
    @if (str_contains(url()->current(), 'dashboard'))
        <label class="col-form-label col-lg-2 col-sm-12">教育&nbsp;<span style="color:red">(必填)</span></label>
    @else
...
<div class="form-group m-form__group row">
    @if (str_contains(url()->current(), 'dashboard'))
        <label class="col-form-label col-lg-2 col-sm-12">婚姻&nbsp;<span style="color:red">(必填)</span></label>
    @else
...
<div class="form-group m-form__group row">
    @if (str_contains(url()->current(), 'dashboard'))
        <label class="col-form-label col-lg-2 col-sm-12">喝酒&nbsp;<span style="color:red">(必填)</span></label>
    @else
...
<div class="form-group m-form__group row">
    @if (str_contains(url()->current(), 'dashboard'))
        <label class="col-form-label col-lg-2 col-sm-12">抽菸&nbsp;<span style="color:red">(必填)</span></label>
    @else
...
<div class="form-group m-form__group row">
    @if (str_contains(url()->current(), 'dashboard'))
        <label class="col-form-label col-lg-2 col-sm-12">資產&nbsp;<span style="color:red">(必填)</span></label>
    @else
        <label class="col-form-label col-lg-2 col-sm-12">資產</label>
    @endif
    <div class="col-lg-5 col-md-10 col-sm-12">
    @if (str_contains(url()->current(), 'dashboard'))
    <input class="form-control m-input" type="number" name="assets" value="{{$umeta->assets}}">
    @else
