...
export default {
  ...
  computed: {
    incomingCallDialog() {
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start incomingCallDialog@computed@export default@VideoVerifyUserEntireSite.vue'
    ...
    callerDetails() {
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start callerDetails@computed@export default@VideoVerifyUserEntireSite.vue'
      ...
      if (
        ...
        log_arr.act_step = 'after';
        log_arr.step = 'end';
        log_arr.title = 'return {id: this.videoCallParams.caller,name: `${incomingCaller[0].name}`}  end callerDetails@computed@export default@VideoVerifyUserEntireSite.vue';
        log_arr.data = {
  ...
  methods: {
    ...
    getMediaPermission() {
        ...
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start and before reutrn this.getPermissions() end getMediaPermission@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      return this.getPermissions()
        .then((stream) => {
            var log_arr = {
                from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'then in return this.getPermissions()@getMediaPermission@methods@export default@VideoVerifyUserEntireSite.vue'
        ...
        .catch((error) => {
            ...
            var log_arr = {
                from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'catch in return this.getPermissions()@getMediaPermission@methods@export default@VideoVerifyUserEntireSite.vue'
    ...
    initializeCallListeners() {
        ...
        var initializeCallListeners_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start initializeCallListeners@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.channel.listen("StartVideoChat", ({ data }) => {
        ...
        var log_arr = {url:location.href
                ,from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'this.videoCallParams.channel.listen(StartVideoChat)_start_in_VideoVerifyUserEntireSite.vue'
                ,data:data
          ...
          $.ajax({
            ...
            error:function(xhr) {
              ...
              $.post('/video/log_video_chat_process'
                        ,{url:location.href
                            ,title:'after_error_ajax_receive-call-user-signal-data_in_VideoVerifyUserEntireSite.vue'
          ...
          this.videoCallParams.callerSignal = updatedSignal;
            ...
            if(data.from==this.videoCallParams.dialingTo  ||  data.from==this.videoCallParams.caller) {
                if(this.callPlaced==true || this.videoCallParams.receivingCall==true) {
                    $('.mask_bg').hide();
                    $('#mnger_leave_page_msg_block').show().css('z-index',40);
                    setTimeout(() => {
    ...
    async placeVideoCall(id, name) {
        ...
        var pvc_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.peer1.on("signal", (data) => {
        ...
        axios
          ...
          .then(() => {
            var log_arr = {
                from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'then in this.videoCallParams.peer1.on("signal", (data) =>@async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
          ...
          .catch((error) => {
            var log_arr = {
                from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'catch in this.videoCallParams.peer1.on("signal", (data) =>@async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.peer1.on("stream", (stream) => {
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'this.videoCallParams.peer1.on("stream", (stream) =>@async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.peer1.on("connect", () => {
        ...
        var log_arr = {url:location.href
                ,from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'peer1 connected in this.videoCallParams.peer1.on("connect", () =>@async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.peer1.on("data", (data) => {
        ...
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'this.videoCallParams.peer1.on("data", (data) =>@async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.peer1.on("error", (err) => {
        ...
        var log_arr = {url:location.href
                ,from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'peer1 error in this.videoCallParams.peer1.on("error", (err) =>@async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
                ,data:{err:err}
      ...
      this.videoCallParams.peer1.on("close", () => {
        ...
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'this.videoCallParams.peer1.on("close", () =>@async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.channel.listen("StartVideoChat", ({ data }) => {
        ...
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'this.videoCallParams.channel.listen("StartVideoChat", ({ data }) =>@async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
    ...
    async acceptCall() {
        ...
        var ac_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start async acceptCall()@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.peer2.on("signal", (data) => {
        ...
        axios
          ...
          .then(() => {
            var log_arr = {
                from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'then in this.videoCallParams.peer2.on("signal", (data) =>@async acceptCall()@methods@export default@VideoVerifyUserEntireSite.vue'
          ...
          .catch((error) => {
            var log_arr = {
                from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'catch in this.videoCallParams.peer2.on("signal", (data) =>@async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.peer2.on("stream", (stream) => {
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'this.videoCallParams.peer2.on("stream", (stream) =>@async placeVideoCall(id, name)@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.peer2.on("connect", () => {
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'peer2 connected in this.videoCallParams.peer2.on("connect", () =>@async acceptCall()@methods@export default@VideoVerifyUserEntireSite.vue'
            ,data:{user_permission:this.user_permission}
      ...
      this.videoCallParams.peer2.on("data", (data) => {
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'this.videoCallParams.peer2.on("data", (data) =>@async acceptCall()@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.peer2.on("error", (err) => {
        var log_arr = {
                from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'peer2 error in this.videoCallParams.peer2.on("error", (err) =>@async acceptCall()@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.videoCallParams.peer2.on("close", () => {
        ...
        var log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'this.videoCallParams.peer2.on("close", () =>@async acceptCall()@methods@export default@VideoVerifyUserEntireSite.vue'
    ...
    toggleCameraArea() {
        var tca_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start toggleCameraArea()@methods@export default@VideoVerifyUserEntireSite.vue'
    ...
    async declineCall() {
        var dc_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start declineCall()@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      await axios
          ...
          .then(() => {
            var log_arr = {
                from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'then in axios@declineCall@methods@export default@VideoVerifyUserEntireSite.vue'
          ...
          .catch((error) => {
            var log_arr = {
                from_file:'VideoVerifyUserEntireSite.vue'
                ,title:'catch in axios@declineCall@methods@export default@VideoVerifyUserEntireSite.vue'
    ...
    receive_data(data) {
        var rd_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start receive_data(data)@methods@export default@VideoVerifyUserEntireSite.vue'
    ...
    stopStreamedVideo(videoElem) {
      var ssv_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start stopStreamedVideo(videoElem)@methods@export default@VideoVerifyUserEntireSite.vue'
    ...
    endCall() {
      var ec_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start endCall()@methods@export default@VideoVerifyUserEntireSite.vue'
    ...
    startRecording() {
      var sr_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start startRecording()@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.mediaRecorder.onstop = (event) => {
        ...
        var mros_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start this.mediaRecorder.onstop = (event) =>@startRecording()@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.mediaRecorder.ondataavailable = (event) => {
        ...
        var mroda_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start this.mediaRecorder.ondataavailable = (event) =>@startRecording()@methods@export default@VideoVerifyUserEntireSite.vue'
      ...
      this.mediaRecorder2.ondataavailable = (event) => {
        var mr2oda_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start this.mediaRecorder2.ondataavailable = (event) =>@startRecording()@methods@export default@VideoVerifyUserEntireSite.vue'
    ...
    stopRecording() {
      var sr_log_arr = {
            from_file:'VideoVerifyUserEntireSite.vue'
            ,title:'start stopRecording()@methods@export default@VideoVerifyUserEntireSite.vue'
    ...
    downloadRecording(recordedChunks,who) {
      ...
      //fetch('/video/log_video_chat_process?url='+encodeURIComponent(location.href)+'&title=before_fetch_video_chat_verify_upload_in_VideoVerifyUserEntireSite.vue_at_downloadRecording&formData='+encodeURIComponent(JSON.stringify(Array.from(formData.entries())))+'&file_name='+file_name);
      const formDataObj = {};
