...
(function() {
  ...
  Loader = (function() {
    function Loader() {
      ...
      this.numLoaded = 0;
      susanName = 'js/fingerprint/assets/Susan.json';
      simpleName = 'js/fingerprint/assets/simple.json';
      colorName = 'js/fingerprint/assets/color.png';
      colorName1 = 'js/fingerprint/assets/color2.png';
