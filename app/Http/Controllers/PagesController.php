...
//            }
    ...
    public function personalPage(Request $request) {
        ...
        } else if ($user->warned_users->video_auth == 1 && $user_isBannedOrWarned->warned_expire_date == null) {
        ...
        } else if ($user->warned_users->video_auth == 1 && $user_isBannedOrWarned->warned_expire_date > now()) {
