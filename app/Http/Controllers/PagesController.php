...
//        }
    ...
    public function getSearchData(Request $request){
        try{
            ...
            //             $ssrData .='<div class="nt_photo '.$ssr_var.'"><img class="lazy" src="'.$assets_url.$ssr_var2.'" data-original="'.$ssr_var2.'" onerror="'.$onerror.'"/></div>'; // need to check again
            ...
            $output = array(
                ...
                // 'singlePageData'=>$vis['singlePageData']
            );
            return json_encode($output);
        }catch (\Exception $e){
