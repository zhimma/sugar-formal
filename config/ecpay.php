...
return [
    ...
    'payment_test' => [
        ...
        'ReturnURL' => "https://sg.test-tw.icu/dashboard/upgradepayEC",  //背景傳送付款結果的網址
        'postChatpayReturnURL' => "https://sg.test-tw.icu/dashboard/postChatpayEC",  //背景傳送車馬費付款結果的網址
        'PeriodReturnURL' => "https://sg.test-tw.icu/dashboard/upgradepayEC",  //背景傳送定期定額付款交易結果的網址
        'ClientChatpayBackURL' => "https://sg.test-tw.icu/dashboard/chat2", //返回商店的網址
        'ClientBackURL' => "https://sg.test-tw.icu/dashboard", //返回商店的網址
        'ServiceURL' => "https://payment-stage.ecpay.com.tw/Cashier/QueryCreditCardPeriodInfo",//定期定額查詢訂單
        'PaymentInfoURL' => "https://sg.test-tw.icu/dashboard/paymentInfoEC",
        // 'OrderResultURL' => "http://fixedip.lzong.tw/dashboard/upgradepay",  //付款結果的網址，若不設則會使用綠界的付款結果
        'postValueAddServiceReturnURL' => "https://sg.test-tw.icu/dashboard/postValueAddedService",  //背景傳送加值服務付款結果的網址
        'postMobileVerifyReturnURL' => "https://sg.test-tw.icu/dashboard/postMobileVerifyPayEC",  //背景傳送手機驗證通過付款結果的網址
        'ClientMobileVerifyBackURL' => "https://sg.test-tw.icu/member_auth", //返回商店的網址
    ],
];
