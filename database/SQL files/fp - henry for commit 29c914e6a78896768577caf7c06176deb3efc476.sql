...
CREATE TABLE IF NOT EXISTS `fingerprint2` (
  ...
  `userAgent` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '使用者代理',
  ...
  `canvas` varchar(5000) COLLATE utf8_unicode_ci NOT NULL COMMENT 'canvas',
  `webgl` varchar(5000) COLLATE utf8_unicode_ci NOT NULL COMMENT 'webgl',
