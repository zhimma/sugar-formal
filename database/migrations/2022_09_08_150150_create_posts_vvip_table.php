...
class CreatePostsVvipTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('posts_vvip')) {
            Schema::create('posts_vvip', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('posts_vvip');
    }
}
